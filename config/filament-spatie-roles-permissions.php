...
return [
    ...
    'navigation_section_group' => 'Права доступа', // Роли и разрешения — в группу сайдбара «Права доступа»

    // Tenancy не используется. Строка вместо ::class — чтобы статический
    // анализатор не ругался на отсутствующий класс App\Models\Team.
