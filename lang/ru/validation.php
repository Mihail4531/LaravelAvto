...
/*
|--------------------------------------------------------------------------
| Сообщения валидации (русский)
|--------------------------------------------------------------------------
|
| Без этого файла Laravel показывает сырые ключи вроде «validation.required»,
| т.к. APP_LOCALE=ru и фолбэка на en нет. Здесь — стандартные правила Laravel
| в переводе. Поля для подстановки в :attribute задаются в массиве 'attributes'.
|
*/
...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'Указанное значение :attribute было скомпрометировано. Выберите другое.',
    ],
